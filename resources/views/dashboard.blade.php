        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-6 shadow sm:rounded-lg">
                    <h3 class="text-gray-500">Kursus Diambil</h3>
                    <p class="text-2xl font-bold">{{ auth()->user()->enrolledCourses()->count() }}</p>
                </div>
                <div class="bg-white p-6 shadow sm:rounded-lg">
                    <h3 class="text-gray-500">Materi Selesai</h3>
                    <p class="text-2xl font-bold">{{ auth()->user()->completedLessons()->count() }}</p>
                </div>
            </div>
